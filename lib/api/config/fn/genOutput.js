...
module.exports = function(config, env) {
    ...
    let _filename = config.js.destDir + (config.js.useHash ? '/[name].[chunkhash:8].js' : '/[name].js');
    ...
    _output = Object.assign({}, {
        ...
        chunkFilename: [path.join(config.js.destDir, 'part/'), config.basic.appName, '.[name].[chunkhash:8].js']
            .join('')
    });
    return _output;
}
