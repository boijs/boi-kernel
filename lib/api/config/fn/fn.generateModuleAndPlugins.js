...
let generateStyleConf = require('./fn.generateStyleConf.js');
...
module.exports = function(conf) {
    ...
    _module = Object.assign({}, {
        loaders: [
            util.inspect(_loader_image, 100),
            util.inspect(_loader_js, 100),
            util.inspect(_loader_style, 100)
        ]
    });
    return Object.assign({}, {
        module: util.inspect(_module, 100),
        plugins: util.inspect(_plugins, 100)
    });
}
